    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean) =
            object : KtVisitorVoid() {
                override fun visitDotQualifiedExpression(expression: KtDotQualifiedExpression) {
                    ...
                    val firstQualifiedExpression = expression.receiverExpression as? KtDotQualifiedExpression ?: return
                    ...
                    val descriptor = holder.manager.createProblemDescriptor(
                            expression,
                            TextRange(firstCallExpression.startOffset - expression.startOffset,
                                      secondCallExpression.calleeExpression!!.endOffset - expression.startOffset),
